 ...
 */
#define EXTI_LINE 		        EXTI_LINE0  /**< The line number for external interrupts. */
 ...
 */
#define EXTI_SENSE_MODE 		EXTI_RISING /**< The mode for external interrupts. Can be RISING, FALLING, or ON_CHANGE. */
